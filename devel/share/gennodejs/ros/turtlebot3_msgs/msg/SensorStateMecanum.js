...
class SensorStateMecanum {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      this.rear_left_encoder = null;
      this.rear_right_encoder = null;
      this.battery = null;
    }
    else {
      ...
      if (initObj.hasOwnProperty('rear_left_encoder')) {
        this.rear_left_encoder = initObj.rear_left_encoder
      }
      else {
        this.rear_left_encoder = 0;
      }
      if (initObj.hasOwnProperty('rear_right_encoder')) {
        this.rear_right_encoder = initObj.rear_right_encoder
      }
      else {
        this.rear_right_encoder = 0;
      }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    // Serialize message field [rear_left_encoder]
    bufferOffset = _serializer.int32(obj.rear_left_encoder, buffer, bufferOffset);
    // Serialize message field [rear_right_encoder]
    bufferOffset = _serializer.int32(obj.rear_right_encoder, buffer, bufferOffset);
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new SensorStateMecanum(null);
    ...
    // Deserialize message field [rear_left_encoder]
    data.rear_left_encoder = _deserializer.int32(buffer, bufferOffset);
    // Deserialize message field [rear_right_encoder]
    data.rear_right_encoder = _deserializer.int32(buffer, bufferOffset);
  ...
  static datatype() {
    ...
    return 'turtlebot3_msgs/SensorStateMecanum';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new SensorStateMecanum(null);
    ...
    if (msg.rear_left_encoder !== undefined) {
      resolved.rear_left_encoder = msg.rear_left_encoder;
    }
    else {
      resolved.rear_left_encoder = 0
    }

    if (msg.rear_right_encoder !== undefined) {
      resolved.rear_right_encoder = msg.rear_right_encoder;
    }
    else {
      resolved.rear_right_encoder = 0
    }
...
module.exports = SensorStateMecanum;
